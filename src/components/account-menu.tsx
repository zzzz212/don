...
// "down" is the default (mobile top bar — trigger lives at top-right,
// menu drops below and right-aligns under the trigger).
//
// "up" is for the sidebar bottom rail: the trigger sits at the BOTTOM-LEFT
// of the viewport (sidebar is `h-screen`), so the menu must rise UPWARD
// and anchor to the LEFT edge of the trigger — a right-anchored menu
// would extend off the left edge of the screen, which is what the
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className={
              placement === "up"
                ? "absolute left-0 bottom-full z-30 mb-2 w-72 max-w-[calc(100vw-2rem)] overflow-hidden rounded-xl border border-border bg-card shadow-xl"
