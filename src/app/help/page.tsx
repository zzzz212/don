...
const FAQS: FaqItem[] = [
  ...
  },
  {
    ...
    aText:
      "Напишите в поддержку на support@juriist.ru с приложением отчёта и описанием ошибки. Мы используем такие случаи для улучшения промпта и сверки справочника статей. За критичные находки готовы вернуть стоимость анализа или предоставить дополнительные проверки.",
    answer: (
      <>
  ...
  },
  {
    ...
    aText:
      "В журнале ЮрИИст есть разборы: ГПХ vs ИП, NDA для IT-компаний, аренда нежилого помещения, договор оказания услуг, маркетплейс-агентский, поставка, трудовой с испытательным сроком, заём между ЮЛ, агентский. Каждая статья со ссылками на статьи ГК и готовыми формулировками.",
    answer: (
      <>
        В{" "}
  ...
  },
  {
    ...
    aText:
      "Прямой интеграции пока нет. На тарифе Business планируется API для отправки документов на анализ — обещаемая дата: 2026 год. Если у вас крупная компания и нужна интеграция уже сейчас — напишите на support@juriist.ru, обсудим.",
    answer: (
      <>
  ...
  },
  {
    ...
    aText:
      "Да, для тарифа Enterprise. Условия — индивидуальные, под ваши требования по data residency. Свяжитесь через support@juriist.ru для обсуждения.",
    answer: (
      <>
        Да, для тарифа{" "}
        <Link href="/billing" className="font-medium text-primary underline">
  ...
  },
  {
    ...
    aText:
      "Email: support@juriist.ru. Отвечаем в течение 24 часов в будние дни. По вопросам, связанным с конкретными отчётами, прикладывайте ID документа из URL отчёта — это ускорит разбор.",
    answer: (
      <>
        Email:{" "}
        <a
